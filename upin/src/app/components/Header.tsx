...
const Header = () => {
  return (
    <nav className=' bg-upinGreen flex justify-between items-center w-full  z-30'>
    ...
    <ul className='flex space-x-4 px-5 mr-12'>
        <li className='hover:text-white text-lg  font-montserrat'>News</li>
        <li className='hover:text-white text-lg  font-montserrat'> <Link href={"/about-us"}>About</Link></li>
        <li className='hover:text-white text-lg  font-montserrat'>Team</li>
    </ul>
