...
import { 
  Card,  Avatar,  Button,  Row,  Col,  Typography,  Space,  Modal, Form, Input, DatePicker, message, Statistic, Tooltip
} from 'antd';
import { 
  EditOutlined,  UserAddOutlined,  UserDeleteOutlined, CalendarOutlined, ManOutlined,
...
import { getFollowingStatuses } from '@/app/account/profileFunctions';
...
const ProfileSection = ({ profileData, isOwnProfile, currentUser, followers, following, communities }: ProfileSectionProps) => {
  ...
  const handleFollow = async () => {
    ...
    message.success(isFollowing ? 'Unfollowed successfully' : 'Following successfully');
  };
  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.profileContent}>
          ...
          <div className={styles.profileInfo}>
            ...
            <Row gutter={24} className={styles.connectionStats}>
              ...
              <Col>
                <Statistic title="Connections" value={(followers?.length || 0) + (following?.length || 0)} />
              </Col>
            </Row>
          </div>
        </div>
                  ...
                  <div key={rowIndex} className={styles.interestRow}>
                    {row.map((interest, index) => {
                      ...
                      return (
                        <div
                          key={index}
                          className={`${styles.interestTag} ${isRanked ? styles.rankedInterestTag : styles.regularInterestTag}`}
                        >
                          {isRanked && (
          ...
          >
            <Space direction="vertical" style={{ width: '100%' }} size={16}>
              <div className={styles.infoItem}>
                ...
                <div>
                  <Text type="secondary" className={styles.infoLabel}>Gender</Text>
              ...
              <div className={styles.infoItem}>
                ...
                <div>
                  <Text type="secondary" className={styles.infoLabel}>Age</Text>
                  <div className={styles.infoValue}>
      ...
      >
        ...
        >
          ...
          <Form.Item
            ...
            name="interests"
          >
            <Input placeholder="Enter interests separated by commas" className={styles.input} />
          </Form.Item>
          ...
          <Form.Item style={{ marginBottom: 0, textAlign: 'right' }}>
            <Space>
              ...
              <Button type="primary" htmlType="submit" loading={updateLoading} className={styles.saveButton}>
                Save Changes
              </Button>
            </Space>
          </Form.Item>
      ...
      <Modal
        ...
        footer={
          <Button type="primary" onClick={() => setShowAppModal(false)} className={styles.popupButton}>
            Close
          </Button>
        }
        width={500}
