    ...
    <div className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="relative w-auto h-auto my-20 bg-upinGreen rounded-3xl p-7 shadow-2xl shadow-slate-400 backdrop-filter backdrop-blur-3xl border border-green-200 bg-opacity-20">
        ...
        <form className="grid grid-cols-2 gap-6 w-full">
          ...
          <legend className="text-2xl col-span-2">
          ...
          <div className="grid grid-cols-2 gap-2 col-span-2">
            <div>
              <input
                ...
                value="Music"
              />
              <label htmlFor="music" className="px-2">
                Music
              </label>
            </div>
            <div>
              <input
                ...
                value="Movies"
              />
              <label htmlFor="movies" className="px-2">
                Movies
              </label>
            </div>
            <div>
              <input
                ...
                value="Gaming"
              />
              <label htmlFor="gaming" className="px-2">
                Gaming
              </label>
            </div>
            <div>
              <input
                ...
                value="Chilling"
              />
              <label htmlFor="chilling" className="px-2">
                Chilling
              </label>
            </div>
            <div>
              <input
                ...
                value="Literature"
              />
              <label htmlFor="literature" className="px-2">
                Literature
              </label>
            </div>
            <div>
